...
public class Neo4jEmbeddingStoreIngestorBaseTest extends Neo4jContainerBaseTest {
    ...
    protected static void seedMainDocAndChildData() {
        try (var session = driver.session()) {
            ...
            final Value embedding1 =
                    Values.value(embeddingModel.embed(text1).content().vector());
            final String text2 = "Spaghetti carbonara and Italian dishes";
            final Value embedding2 =
                    Values.value(embeddingModel.embed(text2).content().vector());
            final String text3 = "Quantum entanglement and uncertainty principles";
            final Value embedding3 =
                    Values.value(embeddingModel.embed(text3).content().vector());
