/**
 * Contains interfaces and classes for model routing functionality.
 *
 * <p>The model routing API enables routing chat requests to different models depending on a pluggable strategy.
 *  *
