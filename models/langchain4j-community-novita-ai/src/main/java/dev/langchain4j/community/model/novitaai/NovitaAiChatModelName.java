...
public enum NovitaAiChatModelName {
    ...
    public static NovitaAiChatModelName fromModelName(String modelName) {
        for (NovitaAiChatModelName model : NovitaAiChatModelName.values()) {
            if (model.getModelId().equals(modelName)) {
                return model;
            }
        }
