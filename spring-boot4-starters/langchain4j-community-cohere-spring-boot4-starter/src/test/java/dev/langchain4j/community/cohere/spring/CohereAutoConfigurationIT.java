    ...
    void should_provide_chat_model() {
        contextRunner
                ...
                .run(context -> {
                    ...
                    assertThat(chatModel.chat("What is the capital of France?")).containsIgnoringCase("Paris");
    ...
    void should_provide_streaming_chat_model() {
        contextRunner
                ...
                .run(context -> {
                    ...
                    streamingChatModel.chat("What is the capital of Finland?", new StreamingChatResponseHandler() {
                        @Override
                    ...
                    assertThat(response.aiMessage().text()).containsIgnoringCase("Helsinki");
