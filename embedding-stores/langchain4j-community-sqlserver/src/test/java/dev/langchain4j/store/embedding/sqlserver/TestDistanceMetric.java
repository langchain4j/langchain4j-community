...
class TestDistanceMetric {
    ...
    void shouldConvertEuclideanDistanceToSimilarityScore() {
        ...
        assertEquals(2.0, DistanceMetric.EUCLIDEAN.distanceToScore(0.0), 0.001); // Perfect similarity: 2 * e^(-0) = 2 * 1 = 2
        assertEquals(0.736, DistanceMetric.EUCLIDEAN.distanceToScore(1.0), 0.001); // Moderate similarity: 2 * e^(-1) ≈ 0.736
        assertEquals(0.100, DistanceMetric.EUCLIDEAN.distanceToScore(3.0), 0.001); // Lower similarity: 2 * e^(-3) ≈ 0.100
        assertEquals(0.013, DistanceMetric.EUCLIDEAN.distanceToScore(5.0), 0.001); // Very low similarity: 2 * e^(-5) ≈ 0.013
    }
}
