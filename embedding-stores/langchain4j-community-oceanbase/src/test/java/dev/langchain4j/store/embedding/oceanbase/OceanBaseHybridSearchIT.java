...
class OceanBaseHybridSearchIT {
    ...
    void test_hybrid_search_with_text_and_vector() {
        ...
        embeddingStore.add(
                ...
                TextSegment.from(
                        "Machine learning algorithms", dev.langchain4j.data.document.Metadata.from("category", "ai")));
    ...
    void test_vector_search_only() {
        // Add test documents
        embeddingStore.add(embeddingModel.embed("Java programming").content(), TextSegment.from("Java programming"));

        embeddingStore.add(
                embeddingModel.embed("Python programming").content(), TextSegment.from("Python programming"));
    ...
    void test_fulltext_search_benefits() {
        ...
        EmbeddingSearchResult<TextSegment> hybridResults = embeddingStore.search(EmbeddingSearchRequest.builder()
                .queryEmbedding(queryEmbedding)
