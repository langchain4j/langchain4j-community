...
import dev.langchain4j.utils.PostgresTestUtils;
...
public class PostgresEngineIT {
    ...
    void initialize_vector_table_with_default_schema() throws SQLException {
        ...
        PostgresTestUtils.verifyColumns(defaultConnection, "public", TABLE_NAME, expectedNames);
    }
    ...
    void initialize_vector_table_overwrite_true() throws SQLException {
        ...
        PostgresTestUtils.verifyColumns(defaultConnection, "public", TABLE_NAME, expectedColumns);
    }
    ...
    void initialize_vector_table_with_custom_options() throws SQLException {
        ...
        PostgresTestUtils.verifyColumns(defaultConnection, CUSTOM_SCHEMA, CUSTOM_TABLE_NAME, expectedColumns);
    }
